...
![Teste 1 - Sucesso](https://github.com/user-attachments/assets/1ea81fcf-56d3-40b4-afda-6ca0351769dd)

### Teste 2: Erro de Tamanho de Nome

Tentativa de criar produto com nome "Te". A API bloqueia e solicita pelo menos 3 caracteres.

![Teste 2 - Erro de Tamanho](https://github.com/user-attachments/assets/edfd05e0-bcad-448f-8e0f-f6b3390a8d2d)

### Teste 3: Erro de Preço Negativo

Tentativa de inserir preço -4. A validação impede a operação.

![Teste 3 - Erro de Preço](https://github.com/user-attachments/assets/1f43b4ae-d009-4ad4-89f0-29cb22b48c45)