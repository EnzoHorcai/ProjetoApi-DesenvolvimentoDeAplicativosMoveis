Aqui está o seu novo README.md adaptado exatamente para o trabalho de Filmes que você acabou de finalizar.

Note que eu mantive o mesmo estilo visual, os mesmos emojis e a mesma organização que você usou no de produtos, mas atualizei todos os textos, regras de negócio e exemplos para o contexto de Filmes.
...
O código possui um sistema de tratamento de erros que retorna 400 Bad Request caso:
    ...
    Tamanho do Nome: O nome do filme deve ter, no mínimo, 3 caracteres.
